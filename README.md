...
✅ **Delta / trend reports** — compare any scan to a baseline → what's **new**, **fixed**, and **still open** (findings keyed by CVE/asset), with a Markdown delta export  
